...
export default async function CrmPage({ searchParams }: Props) {
  ...
  if (cookieStore.get("crm_auth")?.value !== "crm_authenticated") redirect("/crm/login");
      ...
      <head>
        ...
        <style>{`
          *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
          ...
          .hdr-title{font-size:14px;font-weight:700}.hdr-sub{font-size:12px;color:#555}
          ...
          .pull-btn:hover{color:#fff;border-color:#555}
          .pull-btn.ok{border-color:#22c55e;color:#22c55e}.pull-btn.err{border-color:#ef4444;color:#ef4444}
          ...
          .sid-item:hover{background:#2A2A2A;color:#fff}.sid-item.active{background:#C41230;color:#fff}
          ...
          .blk-icon{font-size:15px}.blk-title{font-size:14px;font-weight:700;flex:1}
        ...
        <div className="layout">
          ...
          <div className="main">
            <div className="grid">
              ...
              <div className="block">
                <div className="blk-hdr">
                  ...
                  <span className="blk-title">Oggi</span>
              ...
              <div className="block">
                <div className="blk-hdr">
                  ...
                  {content && hasNewsletter(content.data)
                    ...
                    : <button className="blk-action" onClick={() => {}}>Copia</button>}
                </div>
                <div className="blk-body">
                  {content && hasNewsletter(content.data) ? (
                    <div className="nl-frame">
                      <iframe src={`/newsletters/${content.data}.html`} className="nl-iframe" title="Newsletter" />
                    </div>
              ...
              <div className="block">
                <div className="blk-hdr">
                  <span className="blk-icon">📱</span>
                  <span className="blk-title">Carosello</span>
                  <span className="blk-badge">Instagram</span>
                </div>
                <div className="blk-body">
            ...
            <div className="post-block">
              <div className="blk-hdr">
                <span className="blk-icon">📸</span>
                <span className="blk-title">Descrizione post Instagram</span>
